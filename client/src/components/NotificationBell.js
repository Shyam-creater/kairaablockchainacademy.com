  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute top-0 right-0 inline-flex items-center justify-center w-[18px] h-[18px] text-[10px] font-bold leading-none text-white transform translate-x-1/4 -translate-y-1/4 bg-red-500 rounded-full border border-[#0B0F19]">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 top-[120%] w-80 sm:w-96 bg-[#0B1121] shadow-2xl border border-slate-700/50 rounded-2xl overflow-hidden z-50 origin-top-right flex flex-col max-h-[500px]"
          >
              <div className="p-4 border-b border-slate-700/50 bg-[#111827] flex justify-between items-center">
                <h3 className="font-bold text-white tracking-wide">Notifications</h3>
                <span className="text-[10px] font-extrabold tracking-wider bg-red-500/10 border border-red-500/20 text-red-400 px-3 py-1 rounded-full uppercase">{unreadCount} New</span>
              </div>
