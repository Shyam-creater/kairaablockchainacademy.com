...
import { useGetUserAllCoursesQuery, useGetPublicProjectsQuery } from "../redux/features/courses/coursesApi";
...
const HomePage = () => {
  const { data: coursesData } = useGetUserAllCoursesQuery({});
  const { data: projectsData } = useGetPublicProjectsQuery();
  const coursesList = coursesData?.courses || [];
  const showcaseProjectsList = projectsData?.projects || [];
      ...
      <main className="pt-[80px]">
              ...
              <div className="relative bg-[#050810]/60 backdrop-blur-3xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-[0_0_100px_rgba(0,242,254,0.1)] overflow-hidden">
                ...
                <div className="pt-8">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-6 relative z-20">
                    ...
                    <button onClick={() => navigate('/enquire')} className="w-full sm:w-auto px-10 py-5 bg-white/5 backdrop-blur-xl border border-white/20 text-white text-lg font-extrabold rounded-2xl hover:bg-white/10 hover:border-white/40 transition-all flex items-center justify-center gap-3">
        ...
        <section className="py-32 border-b border-white/5">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ amount: 0.3 }} transition={{ duration: 0.8 }} className="container mx-auto px-6 max-w-5xl text-center">
            ...
            <div className="w-full max-w-3xl mx-auto shadow-[0_0_50px_rgba(37,99,235,0.2)]">
              <CertificateTemplate 
                studentName="STUDENT NAME"
                courseName="Flagship Bootcamp"
                isLocked={true}
              />
            </div>
          </motion.div>
        ...
        <section className="py-32 border-b border-white/5 bg-[#0B1120]">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ amount: 0.3 }} transition={{ duration: 0.6 }} className="container mx-auto px-6 max-w-5xl text-center">
            ...
            <button onClick={() => navigate('/contact')} className="px-8 py-4 bg-white text-[#050810] font-extrabold rounded-xl hover:bg-slate-200 transition-all shadow-[0_0_30px_rgba(255,255,255,0.3)] w-full sm:w-auto">
        ...
        <section className="py-32 relative overflow-hidden">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.9, y: 50 }} whileInView={{ opacity: 1, scale: 1, y: 0 }} viewport={{ amount: 0.3 }} transition={{ duration: 0.8, type: "spring", bounce: 0.4 }} className="container mx-auto px-6 max-w-4xl relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <button onClick={() => window.open('https://wa.me/917092774077', '_blank')} className="px-10 py-5 bg-[#050810] border border-white/20 text-white text-lg font-extrabold rounded-2xl hover:bg-white/5 transition-all w-full sm:w-auto">
                Talk To Advisor
              </button>
            </div>
          </motion.div>
