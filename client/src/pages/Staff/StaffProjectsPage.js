                ...
                <div className="space-y-5">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      className="w-full h-12 px-4 rounded-xl bg-[#0B0F19] border border-slate-600 text-white outline-none focus:border-primary focus:ring-2 focus:ring-primary [color-scheme:dark]"
                    />
                  </div>
