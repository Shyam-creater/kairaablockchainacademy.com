...
function Blockchain() {
  ...
  return (
    <div className="overflow-x-hidden min-h-screen font-sans text-slate-900 bg-white">
      <Heading
        title="Blockchain Certification Program | Kairaa Blockchain Academy"
        description="Advance your career with Kairaa Academy's Blockchain certification course. Explore vast modules, get in-depth knowledge, and earn a recognized certificate."
...
<section className="bg-[#1C1678] pt-20 pb-32 px-6 md:px-12 relative text-white overflow-hidden">
  ...
  <div className="container mx-auto max-w-6xl relative z-10">
    <p className="uppercase tracking-widest text-sm text-orange-400 font-bold mb-6">Elite Live Certification</p>
    ...
    <div className="flex flex-row gap-12 lg:gap-24 items-center justify-between">
      ...
      <div className="w-3/5">
        ...
        <p className="text-blue-100 text-lg leading-relaxed font-paraFont">
          Acquire cutting-edge blockchain expertise. Study foundational principles, advanced smart contracts, consensus algorithms, and decentralized architectures from the premier blockchain training hub.
        </p>
      </div>
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto max-w-6xl px-6 text-center">
            <h2 className="text-3xl md:text-5xl font-extrabold text-[#1C1678] tracking-wide uppercase mb-4 font-headingFont">
              Our <span className="text-orange-500 font-extrabold">Elite Programs</span>
            </h2>
            <p className="text-slate-650 text-lg max-w-xl mx-auto font-paraFont">
              Select an industry-leading certification path to build, deploy, and master decentralized solutions.
            </p>
          </div>
        </section>
