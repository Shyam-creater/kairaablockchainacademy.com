...
function BlockChainCertification() {
  ...
  return (
    <>
      <Heading title="Blockchain Course | Kairaa Blockchain Academy"
        description="Join Kairaa Blockchain Academy's intensive Blockchain Bootcamp and gain hands-on experience in blockchain, Web3, smart contracts, and crypto development."
        keywords="Blockchain bootcamp, Web3 bootcamp, Smart contract training, Crypto bootcamp India, Kairaa Blockchain Academy, Blockchain developer bootcamp, Web3 workshop" />
      <Header
        open={open}
        setOpen={setOpen}
