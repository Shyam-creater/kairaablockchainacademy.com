  ...
  return (
    <div className="overflow-x-hidden">
      <Heading
        ...
        description="Kairaa Blockchain Academy offers expert-led blockchain and Web3 courses, certifications, and spoken English training to boost your tech career."
        keywords="Blockchain Academy, Blockchain Courses, Web3 Training, Crypto Education, Spoken English, Tamil Blockchain Course, Kairaa Coimbatore"
      />
      <Header
