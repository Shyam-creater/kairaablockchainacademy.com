...
import { getPublicProjects, editCourse, getAllCourses, getSingleCourse, uploadCourse,getCourseByUser, addQuestion, addAnswer, generateVideoUrl, addReview, addReplyToReview, getAdminAllCourse, deleteCourse, addLiveSession, updateLiveSession, deleteLiveSession } from "../controllers/course.controller.js";
import { isAuthenticated, authorizeRoles } from "../middleware/auth.js";
// import {  } from "../controllers/user.controller.js";

const courseRouter = express.Router();

courseRouter.get("/get-public-projects", getPublicProjects);
