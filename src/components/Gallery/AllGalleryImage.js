...
import { FiEdit2, FiImage, FiRefreshCw } from "react-icons/fi";
...
const AllGalleryImage = () => {
  ...
  const columns = [
    ...
    { field: "name", headerName: "Image Title", flex: 0.5, minWidth: 150 },
    { field: "description", headerName: "Description", flex: 0.8, minWidth: 200 },
    {
      field: "image",
      headerName: "Image",
      flex: 0.5,
      ...
      renderCell: (params) => {
        return (
          <Button sx={{ minWidth: '40px', width: '40px' }}>
            <Link to={`/admin/edit-gallery-image/${params.row.id}`}>
  ...
  }, [deleteSuccess, deleteError, setOpen, deleteLoading, refetch]);
    ...
    <div className="w-full h-full flex flex-col space-y-6">
      ...
      >
        <div className="bg-white rounded-none border border-gray-100 shadow-sm px-5 py-3 flex items-center gap-3">
          ...
          <div>
            <span className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider block leading-none mb-1">Total Images</span>
