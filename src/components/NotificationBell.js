        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 top-[120%] w-80 sm:w-96 glass-panel shadow-[0_0_40px_rgba(0,0,0,0.5)] border border-slate-600 rounded-2xl overflow-hidden z-50 origin-top-right flex flex-col max-h-[500px]"
            >
