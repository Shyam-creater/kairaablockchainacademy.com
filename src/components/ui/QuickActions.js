...
const QuickActions = () => {
  ...
  const actions = [
    { icon: <HiOutlineDesktopComputer className="w-5 h-5" />, label: "Live Learning Hub", color: "text-primary", bg: "bg-primary/10", border: "border-primary/20", url: "/profile/courses" },
    { icon: <HiOutlineFolderOpen className="w-5 h-5" />, label: "Session Resources", color: "text-secondary", bg: "bg-secondary/10", border: "border-secondary/20", url: "/profile/courses" },
    ...
    { icon: <HiOutlineCalendar className="w-5 h-5" />, label: "Attendance", color: "text-success", bg: "bg-success/10", border: "border-success/20", url: "/profile/dashboard" },
  ];
